...
export type IColumns = { [key: string]: ICell }

export type IRows = { [key: string]: IColumns }
...
export type ICompressedSheets = {
  [key: string]: string
}

export type ICompressedExcelState = {
  workbookData: ICompressedSheets
}
