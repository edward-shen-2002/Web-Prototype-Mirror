...
export const resizeColumnStart = (props) => ({ type: EXCEL_RESIZE_COLUMN_START, ...props });
export const resizeRowStart = (props) => ({ type: EXCEL_RESIZE_ROW_START, ...props });
...
export const resizeRowEnd = (props) => ({ type: EXCEL_RESIZE_ROW_END, ...props });
export const resizeColumnEnd = (props) => ({ type: EXCEL_RESIZE_COLUMN_END, ...props });
