...
export const OPEN_SUBMISSION_PERIOD_DIALOG = 'OPEN_SUBMISSION_PERIOD_DIALOG'
export const CLOSE_SUBMISSION_PERIOD_DIALOG = 'CLOSE_SUBMISSION_PERIOD_DIALOG'
export const OPEN_TEMPLATE_TYPE_DIALOG = 'OPEN_TEMPLATE_TYPE_DIALOG'
export const CLOSE_TEMPLATE_TYPE_DIALOG = 'CLOSE_TEMPLATE_TYPE_DIALOG'
export const OPEN_REPORTING_PERIOD_DIALOG = 'OPEN_REPORTING_PERIOD_DIALOG'
export const CLOSE_REPORTING_PERIOD_DIALOG = 'CLOSE_REPORTING_PERIOD_DIALOG'

// Submissions Store
export const FAIL_SUBMISSIONS_REQUEST = 'FAIL_SUBMISSIONS_REQUEST'
...
// Sheet Name store
export const FAIL_SHEET_NAMES_REQUEST = 'FAIL_SHEET_NAMES_REQUEST'
export const RECEIVE_SHEET_NAMES = 'RECEIVE_SHEET_NAMES'
export const REQUEST_SHEET_NAMES = 'REQUEST_SHEET_NAMES'
export const CREATE_SHEET_NAME = 'CREATE_SHEET_NAME'
export const DELETE_SHEET_NAME = 'DELETE_SHEET_NAME'
export const UPDATE_SHEET_NAME = 'UPDATE_SHEET_NAME'

// Submission Period store
export const FAIL_SUBMISSION_PERIODS_REQUEST = 'FAIL_SUBMISSION_PERIODS_REQUEST'
export const RECEIVE_SUBMISSION_PERIODS = 'RECEIVE_SUBMISSION_PERIODS'
export const REQUEST_SUBMISSION_PERIODS = 'REQUEST_SUBMISSION_PERIODS'
export const CREATE_SUBMISSION_PERIOD = 'CREATE_SUBMISSION_PERIOD'
export const DELETE_SUBMISSION_PERIOD = 'DELETE_SUBMISSION_PERIOD'
export const UPDATE_SUBMISSION_PERIOD = 'UPDATE_SUBMISSION_PERIOD'

// Reporting Period store
export const FAIL_REPORTING_PERIODS_REQUEST = 'FAIL_REPORTING_PERIODS_REQUEST'
export const RECEIVE_REPORTING_PERIODS = 'RECEIVE_REPORTING_PERIODS'
export const REQUEST_REPORTING_PERIODS = 'REQUEST_REPORTING_PERIODS'
export const CREATE_REPORTING_PERIOD = 'CREATE_REPORTING_PERIOD'
export const DELETE_REPORTING_PERIOD = 'DELETE_REPORTING_PERIOD'
export const UPDATE_REPORTING_PERIOD = 'UPDATE_REPORTING_PERIOD'
...
// COA Tree UI Store
export const UPDATE_SELECTED_NODE_COA_TREE_UI =
...
export const EXCEL_DOUBLE_CLICK_EDITABLE_CELL =
...
export const EXCEL_SET_ACTIVE_CELL_INPUT_VALUE =
