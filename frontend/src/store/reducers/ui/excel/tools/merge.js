...
export const getMergedData = (sheetCellData, y, x) =>  sheetCellData[y] && sheetCellData[y][x] ? sheetCellData[y][x].merged : null;

export const getTabFreeSpot = ({
  y, 
  startX,
  endX,
  rowData
...
export const getShiftTabFreeSpot = ({
  y, 
  startX,
  endX,
  rowData
...
export const getShiftEnterFreeSpot = ({
  x,
  startY,
  endY,
  sheetCellData
