...
const RegisterForm = ({
  ...
  userProgram,
  handleProgramChange,
  handleOpenOrganizationsDialog,
  handleOpenProgramsDialog,
}) => (
  <form className="register__form" onSubmit={handleSubmit}>
    ...
    <Button
      ...
      color="secondary"
      variant="contained"
      onClick={handleOpenOrganizationsDialog}
      fullWidth
    >
      Set Organizations
    </Button>
    <Button
      ...
      color="secondary"
      variant="contained"
      onClick={handleOpenProgramsDialog}
      fullWidth
    >
      Set Programs
    </Button>
...
const RegisterFormContainer = (props) => {
  ...
  const handleOpenOrganizationsDialog = () => {
    ...
    publicAxios
      .get(`${REST_PUBLIC_DATA}/organizations`)
      .then(
        ({
          data: {
            data: { organizations },
  ...
  const handleDeleteUserProgram = (userProgram) => {
    ...
    const newUserPrograms = [
      ...userPrograms.slice(0, userProgramIndex),
      ...userOrganizations.slice(userProgramIndex + 1),
    ]
