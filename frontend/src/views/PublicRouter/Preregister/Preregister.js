...
let Preregister = ({ isOnline, history }) => {
  return (
    <>
    <Header/>
    <div className="preregister">
        ...
        <Paper className="preregister__container">
          ...
          <Box border={1} color="primary" className="preregister__buttonBox" justifyContent="center">
            <Button variant="outlined" color="primary" className="preregister__button" href={ROUTE_PUBLIC_REGISTER} >I ACCEPT</Button>
            <Button variant="outlined" color="primary" className="preregister__button" href={ROUTE_PUBLIC_LOGIN} >CANCEL</Button>
          </Box>
        </Paper>
      </div>
      </>
