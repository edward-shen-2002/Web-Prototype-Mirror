...
const AdminRouter = () => (
  <Switch>
    <AdminRoleRoute
      ...
      requiredRole={ROLE_USER_MANAGER}
      Component={UserRouter}
    />
    {/* <AdminRoleRoute path={ROUTE_ADMIN_SECTOR} requiredRole={ROLE_SECTOR_MANAGER} Component={SectorRouter}/> */}
    <AdminRoleRoute
      path={ROUTE_ADMIN_BUNDLE}
      requiredRole={ROLE_BUNDLE_MANAGER}
      Component={BundleRouter}
    />
    <AdminRoleRoute
      path={ROUTE_ADMIN_ORGANIZATION}
      requiredRole={ROLE_ORGANIZATION_MANAGER}
      Component={OrganizationRouter}
    />
    <AdminRoleRoute
      path={ROUTE_ADMIN_TEMPLATE}
      requiredRole={ROLE_TEMPLATE_MANAGER}
      Component={TemplateRouter}
    />
    <AdminRoleRoute
      path={ROUTE_ADMIN_DATA_ENTITY}
      requiredRole={ROLE_DATA_ENTITY_MANAGER}
      Component={DataEntityRouter}
    />
