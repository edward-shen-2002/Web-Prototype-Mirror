...
const BusinessConceptRouter = () => (
  <Switch>
    <Route exact path={ROUTE_ADMIN_BUSINESS_CONCEPTS} component={BusinessConcepts}/>
    <Route path={ROUTE_ADMIN_BUSINESS_CONCEPTS} component={BusinessConcepts}/>
